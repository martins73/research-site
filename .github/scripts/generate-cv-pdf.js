...
const { PDFDocument, PDFName } = require('pdf-lib'); // Import PDFName
...
async function generatePDF() {
  ...
  try {
    ...
    // CRITICAL FIX: Remove the XMP Metadata stream generated by Puppeteer.
    // This forces browsers to read the Info dictionary (setTitle) instead.
    pdfDoc.catalog.delete(PDFName.of('Metadata'));
    
    // Set the Info dictionary values
    pdfDoc.setTitle('Martin Gonzalez Cabello - CV');
    pdfDoc.setAuthor('Martin Gonzalez Cabello');
    pdfDoc.setSubject('Curriculum Vitae');

    // Correctly set ViewerPreferences so the browser displays the title
